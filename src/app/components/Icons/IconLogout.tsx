export const IconLogout = ({ classes } : { classes: string }) => (
    <svg className={classes} fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
	 viewBox="0 0 471.2 471.2" aria-hidden="true">
        <g>
            <g>
