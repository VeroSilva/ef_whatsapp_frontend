export const IconWarning = ({ classes }: { classes: string }) => (
    <svg className={classes} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M12 8V13" stroke="currentColor" stroke-width="1.7" strokeLinecap="round" />
        <path d="M12 16L12 16.5" stroke="currentColor" stroke-width="1.7" strokeLinecap="round" />
    </svg>
)
